...
export const t = {
  en: {
    ...
    deleteProfileConfirm: "Are you sure? All your skin profile data will be permanently deleted.",
  ...
  ru: {
    ...
    deleteProfile: "Удалить данные профиля",
    deleteProfileConfirm: "Вы уверены? Все данные вашего профиля будут удалены без возможности восстановления.",
  ...
  de: {
    ...
    deleteProfile: "Profildaten löschen",
    deleteProfileConfirm: "Sind Sie sicher? Alle Ihre Profildaten werden unwiderruflich gelöscht.",
  ...
  uk: {
    ...
    deleteProfile: "Видалити дані профілю",
    deleteProfileConfirm: "Ви впевнені? Усі дані вашого профілю будуть видалені без можливості відновлення.",
  ...
  es: {
    ...
    deleteProfile: "Eliminar datos del perfil",
    deleteProfileConfirm: "¿Estás seguro? Todos los datos de tu perfil se eliminarán permanentemente.",
  ...
  fr: {
    ...
    deleteProfile: "Supprimer les données du profil",
    deleteProfileConfirm: "Êtes-vous sûr(e) ? Toutes les données de votre profil seront supprimées définitivement.",
  ...
  it: {
    ...
    deleteProfile: "Elimina dati del profilo",
    deleteProfileConfirm: "Sei sicuro/a? Tutti i dati del tuo profilo verranno eliminati definitivamente.",
  ...
  tr: {
    ...
    deleteProfile: "Profil verilerini sil",
    deleteProfileConfirm: "Emin misiniz? Tüm profil verileriniz kalıcı olarak silinecektir.",
