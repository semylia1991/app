...
<div className="w-28 h-28 rounded-sm border border-[
#D4C3A3] bg-[
#F5F0E8] overflow-hidden flex items-center justify-center shadow-sm">
{state === ‘loading’ && (
<div className="w-6 h-6 rounded-full border-2 border-[
#B89F7A]/30 border-t-[
#B89F7A] animate-spin" />
)}
{state === ‘loaded’ && src && (
...
<div className="fixed top-0 left-0 w-full h-32 bg-gradient-to-b from-[
#B89F7A]/10 to-transparent pointer-events-none z-0" />
<div className="fixed bottom-0 left-0 w-full h-32 bg-gradient-to-t from-[
#B89F7A]/10 to-transparent pointer-events-none z-0" />
