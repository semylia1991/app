...
const guideContent: Record<Language, {
  ...
  en: {
    ...
    features: [
      ...
      { icon: '🔄', title: 'Alternatives', desc: '2–3 real products with a similar formula — in case something didn\'t suit you or the product is unavailable.' },
  ...
  ru: {
    ...
    features: [
      ...
      { icon: '🔄', title: 'Альтернативы', desc: '2–3 реальных продуктов со схожим составом — если что-то в формуле не устроило или продукт недоступен.' },
  ...
  de: {
    ...
    features: [
      ...
      { icon: '🔄', title: 'Alternativen', desc: '2–3 reale Produkte mit ähnlicher Formel — falls etwas nicht zusagt oder das Produkt nicht verfügbar ist.' },
  ...
  uk: {
    ...
    features: [
      ...
      { icon: '🔄', title: 'Альтернативи', desc: '2–3 реальних продуктів зі схожим складом — якщо щось не влаштувало або продукт недоступний.' },
  ...
  es: {
    ...
    features: [
      ...
      { icon: '🔄', title: 'Alternativas', desc: '2–3 productos reales con fórmula similar — si algo no convenció o el producto no está disponible.' },
  ...
  it: {
    ...
    features: [
      ...
      { icon: '🔄', title: 'Alternative', desc: '2–3 prodotti reali con formula simile — se qualcosa non ha convinto o il prodotto non è disponibile.' },
  ...
  tr: {
    ...
    features: [
      ...
      { icon: '🔄', title: 'Alternatifler', desc: 'Benzer formüle sahip 2–3 gerçek ürün — bir şey tatmin etmediyse veya ürün mevcut değilse.' },
