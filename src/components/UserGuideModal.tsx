...
const guideContent: Record<Language, {
  ...
  en: {
    ...
    features: [
      ...
      { icon: '🟡', title: 'Known Sensitivities', desc: 'Possible skin sensitivities by category: irritation for certain skin types, allergies, sensitivities from prolonged use.' },
  ...
  ru: {
    ...
    features: [
      ...
      { icon: '🟡', title: 'Известные чувствительности', desc: 'Возможные кожные чувствительности по категориям: раздражение у некоторых типов кожи, аллергии, чувствительность при длительном применении.' },
  ...
  de: {
    ...
    features: [
      ...
      { icon: '🟡', title: 'Bekannte Unverträglichkeiten', desc: 'Mögliche Hautempfindlichkeiten nach Kategorie: Reizungen bei bestimmten Hauttypen, Allergien, Empfindlichkeiten bei Langzeitanwendung.' },
  ...
  uk: {
    ...
    features: [
      ...
      { icon: '🟡', title: 'Відомі чутливості', desc: 'Можливі чутливості шкіри за категоріями: подразнення для певних типів шкіри, алергії, чутливість при тривалому застосуванні.' },
  ...
  es: {
    ...
    features: [
      ...
      { icon: '🟡', title: 'Sensibilidades conocidas', desc: 'Posibles sensibilidades cutáneas por categoría: irritación en ciertos tipos de piel, alergias, sensibilidades por uso prolongado.' },
  ...
  fr: {
    ...
    features: [
      ...
      { icon: '🟡', title: 'Sensibilités connues', desc: 'Sensibilités cutanées possibles par catégorie : irritations pour certains types de peau, allergies, sensibilités liées à une utilisation prolongée.' },
  ...
  it: {
    ...
    features: [
      ...
      { icon: '🟡', title: 'Sensibilità note', desc: 'Possibili sensibilità cutanee per categoria: irritazione per alcuni tipi di pelle, allergie, sensibilità dovute a un uso prolungato.' },
  ...
  tr: {
    ...
    features: [
      ...
      { icon: '🟡', title: 'Bilinen Hassasiyetler', desc: 'Kategoriye göre olası cilt hassasiyetleri: bazı cilt tiplerinde tahriş, alerjiler, uzun süreli kullanımdan kaynaklanan hassasiyetler.' },
