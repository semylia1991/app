...
const COPY: Record<Language, {
  ...
  en: {
    ...
    malteser: "I also volunteer at Malteser Hilfsdienst — when you go Premium, 5% goes where I help.",
  ...
  de: {
    ...
    malteser: 'Ich bin auch ehrenamtlich beim Malteser Hilfsdienst — wenn du Premium wählst, gehen 5% dorthin, wo ich helfe.',
  ...
  ru: {
    ...
    malteser: 'Ещё я волонтёрю в Malteser Hilfsdienst — когда перейдёшь на платный план, 5% пойдут туда, где я помогаю.',
  ...
  uk: {
    ...
    malteser: 'Ще я волонтерю у Malteser Hilfsdienst — коли перейдеш на платний план, 5% підуть туди, де я допомагаю.',
  ...
  es: {
    ...
    malteser: 'También soy voluntaria en Malteser Hilfsdienst — cuando elijas Premium, el 5% irá donde yo ayudo.',
  ...
  fr: {
    ...
    malteser: "Je suis aussi bénévole chez Malteser Hilfsdienst — quand tu passes en Premium, 5% vont là où j'aide.",
  ...
  it: {
    ...
    malteser: 'Sono anche volontaria al Malteser Hilfsdienst — quando scegli Premium, il 5% va dove aiuto.',
