...
const L: Record<Language, {
  ...
  en: {
    ...
    skip: 'Skip',
    thanks: 'Thank you! 💛',
    thanksNote: 'Your feedback will make GlowKI better for everyone.',
  },
  ru: {
    beta: '🌿 Бета-версия',
    title: 'Помоги улучшить GlowKI',
    ...
    skip: 'Пропустить',
    thanks: 'Спасибо! 💛',
    thanksNote: 'Ваш отзыв поможет сделать GlowKI лучше для всех.',
  },
  de: {
    beta: '🌿 Beta-Version',
    title: 'Hilf uns, GlowKI zu verbessern',
    ...
    skip: 'Überspringen',
    thanks: 'Danke! 💛',
    thanksNote: 'Dein Feedback macht GlowKI für alle besser.',
  },
  uk: {
    beta: '🌿 Бета-версія',
    title: 'Допоможи покращити GlowKI',
    ...
    skip: 'Пропустити',
    thanks: 'Дякую! 💛',
    thanksNote: 'Твій відгук зробить GlowKI кращим для всіх.',
  },
  es: {
    beta: '🌿 Versión beta',
    title: 'Ayúdanos a mejorar GlowKI',
    ...
    skip: 'Omitir',
    thanks: '¡Gracias! 💛',
    thanksNote: 'Tu opinión hará GlowKI mejor para todos.',
  },
  fr: {
    beta: '🌿 Version bêta',
    title: 'Aide-nous à améliorer GlowKI',
    ...
    skip: 'Passer',
    thanks: 'Merci ! 💛',
    thanksNote: 'Ton avis rendra GlowKI meilleur pour tous.',
  },
  it: {
    beta: '🌿 Versione beta',
    title: 'Aiutaci a migliorare GlowKI',
    ...
    skip: 'Salta',
    thanks: 'Grazie! 💛',
    thanksNote: 'Il tuo feedback migliorerà GlowKI per tutti.',
  },
  tr: {
    beta: '🌿 Beta sürümü',
    title: 'GlowKI\'yi geliştirmemize yardım et',
    ...
    skip: 'Atla',
    thanks: 'Teşekkürler! 💛',
    thanksNote: 'Geri bildiriminiz GlowKI\'i herkes için daha iyi yapacak.',
  },
};
